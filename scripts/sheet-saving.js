...
let getInputValues = () => {
    ...
    document.getElementById("skillRadio70").checked = JSON.parse(localStorage.getItem("skillRadio70" + nameCheck));
    document.getElementById("skillRadio71").checked = JSON.parse(localStorage.getItem("skillRadio71" + nameCheck));
    document.getElementById("skillRadio72").checked = JSON.parse(localStorage.getItem("skillRadio72" + nameCheck));
    ...
    document.getElementById("unskillRadio4").checked = JSON.parse(localStorage.getItem("unskillRadio4" + nameCheck));
    document.getElementById("unskillRadio5").checked = JSON.parse(localStorage.getItem("unskillRadio5" + nameCheck));
    document.getElementById("unskillRadio6").checked = JSON.parse(localStorage.getItem("unskillRadio6" + nameCheck));
    document.getElementById("unskillRadio7").checked = JSON.parse(localStorage.getItem("unskillRadio7" + nameCheck));
    document.getElementById("unskillRadio8").checked = JSON.parse(localStorage.getItem("unskillRadio8" + nameCheck));
    document.getElementById("unskillRadio9").checked = JSON.parse(localStorage.getItem("unskillRadio9" + nameCheck));
    document.getElementById("unskillRadio10").checked = JSON.parse(localStorage.getItem("unskillRadio10" + nameCheck));
    document.getElementById("unskillRadio11").checked = JSON.parse(localStorage.getItem("unskillRadio11" + nameCheck));
    document.getElementById("unskillRadio12").checked = JSON.parse(localStorage.getItem("unskillRadio12" + nameCheck));
    document.getElementById("unskillRadio13").checked = JSON.parse(localStorage.getItem("unskillRadio13" + nameCheck));
    document.getElementById("unskillRadio14").checked = JSON.parse(localStorage.getItem("unskillRadio14" + nameCheck));
    document.getElementById("unskillRadio15").checked = JSON.parse(localStorage.getItem("unskillRadio15" + nameCheck));
    document.getElementById("unskillRadio16").checked = JSON.parse(localStorage.getItem("unskillRadio16" + nameCheck));
    document.getElementById("unskillRadio17").checked = JSON.parse(localStorage.getItem("unskillRadio17" + nameCheck));
    document.getElementById("unskillRadio18").checked = JSON.parse(localStorage.getItem("unskillRadio18" + nameCheck));
    ...
    document.getElementById("skill26").value = localStorage.getItem("skill26" + nameCheck);

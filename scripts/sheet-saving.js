...
let getInputValues = () => {
    ...
    document.getElementById("skillRadio73").checked = JSON.parse(localStorage.getItem("skillRadio73" + nameCheck));
    document.getElementById("skillRadio74").checked = JSON.parse(localStorage.getItem("skillRadio74" + nameCheck));
    document.getElementById("skillRadio75").checked = JSON.parse(localStorage.getItem("skillRadio75" + nameCheck));
    document.getElementById("skillRadio76").checked = JSON.parse(localStorage.getItem("skillRadio76" + nameCheck));
    document.getElementById("skillRadio77").checked = JSON.parse(localStorage.getItem("skillRadio77" + nameCheck));
    document.getElementById("skillRadio78").checked = JSON.parse(localStorage.getItem("skillRadio78" + nameCheck));
    document.getElementById("skillRadio79").checked = JSON.parse(localStorage.getItem("skillRadio79" + nameCheck));
    document.getElementById("skillRadio80").checked = JSON.parse(localStorage.getItem("skillRadio80" + nameCheck));
    document.getElementById("skillRadio81").checked = JSON.parse(localStorage.getItem("skillRadio81" + nameCheck));
    document.getElementById("skillRadio82").checked = JSON.parse(localStorage.getItem("skillRadio82" + nameCheck));
    document.getElementById("skillRadio83").checked = JSON.parse(localStorage.getItem("skillRadio83" + nameCheck));
    document.getElementById("skillRadio84").checked = JSON.parse(localStorage.getItem("skillRadio84" + nameCheck));
    document.getElementById("skillRadio85").checked = JSON.parse(localStorage.getItem("skillRadio85" + nameCheck));
    document.getElementById("skillRadio86").checked = JSON.parse(localStorage.getItem("skillRadio86" + nameCheck));
    document.getElementById("skillRadio87").checked = JSON.parse(localStorage.getItem("skillRadio87" + nameCheck));
    document.getElementById("skillRadio88").checked = JSON.parse(localStorage.getItem("skillRadio88" + nameCheck));
    document.getElementById("skillRadio89").checked = JSON.parse(localStorage.getItem("skillRadio89" + nameCheck));
    document.getElementById("skillRadio90").checked = JSON.parse(localStorage.getItem("skillRadio90" + nameCheck));
    document.getElementById("skillRadio91").checked = JSON.parse(localStorage.getItem("skillRadio91" + nameCheck));
    document.getElementById("skillRadio92").checked = JSON.parse(localStorage.getItem("skillRadio92" + nameCheck));
    document.getElementById("skillRadio93").checked = JSON.parse(localStorage.getItem("skillRadio93" + nameCheck));
